\chapter{Lab 71: IGP -- \textit{Interior Gateway Protocol}s, tunele GRE (TODO: tunele osobno)}
...
\cmdc{config-router}{log-adjacency-changes}{Wyświetlaj komunikaty o zmianie sąsiadów TODO: sprawdzić}
...
\cmde{show ip ospf border-routers}{Wyświetlenie routerów ABR TODO: sprawdzić}

\subsubsection{Debugowanie}
\cmde{debug ip ospf adjacency}{Debugowanie zmian adjacencji (sąsiadów) TODO: sprawdzić}
...
\cmde{show ip protocols}{TODO: sprawdzić}
\cmde{debug ip routing}{Włączenie debugowania routingu}
\cmde{clear ip route *}{Czyszczenie danych routingu protokołów dynamicznych TODO: sprawdzić, czy kasuje statyczne wpisy}
